...
// Dummy image data specifically for the '2024' album
const year2024Images: AlbumImage[] = [
  ...
  { id: 141, src: "/2024/141.jpg", alt: "Event Photo 141" },
...
// Main component for the 2024 Album Page
export default function Album2024Page() { // Renamed component for clarity
  return (
