    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white font-inter relative overflow-hidden p-6 md:p-12">
      ...
      <main className="relative z-20 container mx-auto bg-gray-800 bg-opacity-70 backdrop-blur-sm rounded-xl p-6 md:p-10 shadow-2xl">
        ...
        <div className="prose prose-invert max-w-none text-gray-300"> {/* Using prose for better readability of text content */}
          <h2 className="text-3xl font-bold text-white mb-4">Welcome to Your Ayesha's Photo Gallery!</h2>
          <p>
          ...
          <p>
            Upon arriving at the main page, you'll see a prominent "Photo Gallery" title on the left, along with placeholder social media icons.
          ...
          <p>
            When you click on an album card from the main gallery, you'll be directed to its dedicated detail page.
          ...
          <p>
            <strong>Returning to the Main Gallery:</strong> At the top right of any album detail page, you'll find a "Back to Gallery" button.
          ...
          <p>
            From the main gallery page, located on the left side below the social media icons, you'll find a "View Notes" button.
          ...
          <p>
            ...
            It's a space for heartfelt messages and visual complements to those sentiments.
          </p>
          <p>
          ...
          <p>
            For any inquiries or to connect, you can use the social media icons provided on the main page.
          </p>
          
          {/* New Note */}
          <p className="mt-8 p-4 bg-gray-700 rounded-lg text-yellow-200 text-center text-lg font-semibold">
            Please note: While I've put in my best efforts to create this website, I was unable to implement all image, video, or picture uploads from your local computer. But this is i made with love and effort.
          </p>

          <p className="mt-6 text-center text-gray-400">
            Thank you for using this Ayesha's Photo Gallery!
